...
echo "      ${CYAN}cd /home/SIGA/frontend && NEXT_PUBLIC_API_URL=https://asamblea.coopreducto.coop.py npm run dev${NC}"
echo ""
echo "   2. Los cambios en código son INSTANTÁNEOS (hot reload)"
echo "   3. El sitio sigue accesible en https://asamblea.coopreducto.coop.py"
