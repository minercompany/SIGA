                ...
                <div className="overflow-hidden rounded-2xl sm:rounded-3xl md:rounded-[3rem] bg-white/95 backdrop-blur-xl shadow-2xl border border-white/50">
                    <div className="grid md:grid-cols-2">
                        ...
                        <div className="hidden md:flex relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-500 to-emerald-500 p-12 flex-col justify-center items-center min-h-[600px]">
                            ...
                            <div className="absolute -left-10 -top-10 h-[300px] w-[300px] rounded-[60%_40%_70%_30%/50%_60%_40%_50%] bg-emerald-500/30 blur-2xl"></div>
                        ...
                        <div className="flex flex-col min-h-[auto] sm:min-h-[450px] md:min-h-auto">
                            ...
                            <div className="md:hidden relative overflow-hidden bg-gradient-to-br from-emerald-500 via-emerald-500 to-emerald-500 px-5 py-6 sm:px-6 sm:py-8">
                                {/* Formas decorativas internas móvil */}
                                <div className="absolute -left-10 -top-10 h-[150px] w-[150px] rounded-[60%_40%_70%_30%/50%_60%_40%_50%] bg-emerald-500/30 blur-2xl"></div>
                                    ...
                                    <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5 md:space-y-6">
                                        <div className="space-y-1.5 sm:space-y-2">
                                            ...
                                            <div className="relative group">
                                                <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl sm:rounded-2xl border-2 border-slate-100 bg-slate-50 py-3 sm:py-3.5 md:py-4 pl-10 sm:pl-12 pr-3 sm:pr-4 text-sm sm:text-base text-slate-700 outline-none focus:border-emerald-500 focus:bg-white transition-all font-bold"
                                        ...
                                        <div className="space-y-1.5 sm:space-y-2">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl sm:rounded-2xl border-2 border-slate-100 bg-slate-50 py-3 sm:py-3.5 md:py-4 pl-10 sm:pl-12 pr-10 sm:pr-12 text-sm sm:text-base text-slate-700 outline-none focus:border-emerald-500 focus:bg-white transition-all font-bold"
                                                    placeholder="Ingresa tu contraseña"
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => setShowPassword(!showPassword)}
                                                    className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-emerald-500 transition-colors"
                                                >
                                        ...
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="group w-full rounded-xl sm:rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-500 py-3.5 sm:py-4 md:py-5 font-black text-sm sm:text-base text-white shadow-xl shadow-emerald-200 hover:shadow-2xl hover:shadow-emerald-300 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2 sm:gap-3 relative overflow-hidden"
                                        >
                                            <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity"></span>
